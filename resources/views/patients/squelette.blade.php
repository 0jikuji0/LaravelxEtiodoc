...
<body>
    ...
    function skeletonInteractive() {
        return {
            selectedOs: null,
            osList: [
                { name: 'Crâne', src: 'images/crane.png', style: 'top:0px; left:260px; width:90px;' },
                { name: 'Machoire', src: 'images/machoire.png', style: 'top:77px; left:276px; width:65px;' },
                ...
                { name: 'Sternum', src: 'images/sternum.png', style: 'top:170px; left:275px; width:65px;' },
                ...
                { name: 'Colonne 1', src: 'images/colonne_1.png', style: 'top:290px; left:266px; width:80px;' },
                { name: 'Colonne 2', src: 'images/colonne_2.png', style: 'top:350px; left:229px; width:160px;' },
                { name: 'Colonne 3', src: 'images/colonne_3.png', style: 'top:480px; left:273px; width:75px;' },
