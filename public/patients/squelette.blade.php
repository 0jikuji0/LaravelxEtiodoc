...
<head>
    ...
    <style>
        ...
        .skeleton-container img {
            position: absolute;
            cursor: pointer;
    transition: filter 0.6s ease, opacity 0.3s ease, transform 0.2s ease;
    image-rendering: auto; /* helps reduce pixelation */
    opacity: 0.9;
        }

        .skeleton-container img:hover {
        ...
        <div class="skeleton-container">
            <template x-for="os in osList" :key="os.name">
                <img 
                    :src="os.src" 
                    :alt="os.name" 
                   :style="os.style + '; ' + (selectedOs === os.name ? getColorFilter(os) : 'filter: brightness(0.95) saturate(0%) contrast(85%);')"
    ...
    function skeletonInteractive() {
        return {
         ...
         osList: [
            ...
            // Bras
            { name: 'Humérus D', src: 'images/humerus_d.png', style: 'top:190px; left:410px; width:55px;' },
...
/*
           ...
           */// Sacrum & bassin
            { name: 'Sacrum H', src: 'images/sacrum_h.png', style: 'top:480px; left:272px; width:70px;' },
            { name: 'Sacrum B', src: 'images/sacrum_b.png', style: 'top:509px; left:297px; width:20px;' },
            { name: 'Os oxal H D', src: 'images/os_oxal_h_d.png', style: 'top:485px; left:328px; width:52px;' },
            { name: 'Os oxal H G', src: 'images/os_oxal_h_g.png', style: 'top:485px; left:232px; width:54px;' },
            { name: 'Os oxal B 1 D', src: 'images/os_oxal_b_1_d.png', style: 'top:534px; left:323px; width:40px;' },
            { name: 'Os oxal B 1 G', src: 'images/os_oxal_b_1_g.png', style: 'top:534px; left:248px; width:40px;' },
            { name: 'Os oxal B 2 D', src: 'images/os_oxal_b_2_d.png', style: 'top:562px; left:306px; width:32px;' },
            { name: 'Os oxal B 2 G', src: 'images/os_oxal_b_2_g.png', style: 'top:562px; left:275px; width:30px;' },

            // Jambes
            { name: 'Fémur D', src: 'images/femur_d.png', style: 'top:601px; left:299px; width:160px;' },
            { name: 'Fémur G', src: 'images/femur_g.png', style: 'top:585px; left:170px; width:177px;' },
            { name: 'Genou D', src: 'images/genou_d.png', style: 'top:800px; left:358px; width:40px;' },
            { name: 'Genou G', src: 'images/genou_g.png', style: 'top:792px; left:207px; width:42px;' },
            { name: 'Tibia D', src: 'images/tibia_d.png', style: 'top:830px; left:277px; width:140px;' },
            { name: 'Tibia G', src: 'images/tibia_g.png', style: 'top:823px; left:195px; width:140px;' },
            { name: 'Talon D', src: 'images/talon_d.png', style: 'top:1063px; left:325px; width:31px;' },
            { name: 'Talon G', src: 'images/talon_g.png', style: 'top:1058px; left:253px; width:33px;' },
            { name: 'Pied Haut D', src: 'images/pied_haut_d.png', style: 'top:1050px; left:363px; width:20px; ' },
            { name: 'Pied Haut G', src: 'images/pied_haut_g.png', style: 'top:1045px; left:229px; width:20px; ' },
            { name: 'Orteils haut D', src: 'images/orteils_h_d.png', style: 'top:1050px; left:378px; width:20px;' },
            { name: 'Orteils haut G', src: 'images/orteils_h_g.png', style: 'top:1046px; left:215px; width:20px;' },
            { name: 'Orteils D', src: 'images/orteils_d.png', style: 'top:1051px; left:395px; width:30px;' },
            { name: 'Orteils G', src: 'images/orteils_g.png', style: 'top:1055px; left:169px; width:40px;' }
        ],
    ...
    const top = parseInt(os.style.match(/top:(\d+)px/)[1]);
    let color = 'red';
    if (top < 100) color = 'red';       // tête
    else if (top < 200) color = 'yellow'; // épaules
    else if (top < 500) color = 'orange'; // thorax
    else if (top < 650) color = 'green';  // bassin
    else if (top < 800) color = 'blue';   // jambes
    else color = 'purple';                // pieds

    // Filtres de couleur approximatifs pour PNG noirs
const filters = {
    red: 'filter: brightness(0) saturate(100%) invert(20%) sepia(50%) saturate(2000%) hue-rotate(0deg) brightness(100%) contrast(90%);',
    yellow: 'filter: brightness(0) saturate(100%) invert(80%) sepia(40%) saturate(500%) hue-rotate(10deg) brightness(100%) contrast(95%);',
    orange: 'filter: brightness(0) saturate(100%) invert(55%) sepia(60%) saturate(1500%) hue-rotate(5deg) brightness(100%) contrast(95%);',
    green: 'filter: brightness(0) saturate(100%) invert(70%) sepia(30%) saturate(1000%) hue-rotate(60deg) brightness(95%) contrast(90%);',
    blue: 'filter: brightness(0) saturate(100%) invert(40%) sepia(50%) saturate(1500%) hue-rotate(190deg) brightness(100%) contrast(95%);',
    purple: 'filter: brightness(0) saturate(100%) invert(20%) sepia(60%) saturate(2500%) hue-rotate(280deg) brightness(90%) contrast(95%);'
};
